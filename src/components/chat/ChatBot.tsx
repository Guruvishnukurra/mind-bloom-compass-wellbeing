      ...
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Wellbeing Assistant</CardTitle>
          </div>
          <Button 
            variant="outline" 
            size="sm" 
        ...
        <CardDescription>
          Chat with your AI wellbeing assistant for support and guidance
        </CardDescription>
      </CardHeader>
        ...
        <ScrollArea className="flex-1 p-4">
          {messages.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center text-muted-foreground p-4">
              ...
              <p className="text-lg font-medium mb-2">Welcome to your Wellbeing Assistant</p>
              ...
              <ul className="mt-4 text-left list-disc pl-4 space-y-1">
                ...
                <li>How to use the features in this app</li>
